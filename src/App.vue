...
html, body { margin: 0; padding: 0; height: 100%; font-family: 'Segoe UI', system-ui, -apple-system, sans-serif; background: #f0f2f6; -webkit-font-smoothing: antialiased; }
#app { height: 100%; }
button { font-family: inherit; }
</style>
<style scoped>
.app { display: flex; flex-direction: column; height: 100vh; }
.app-header { background: #fff; border-bottom: 1px solid #e5e8ed; padding: 0 24px; height: 56px; display: flex; align-items: center; flex-shrink: 0; }
...
.app-main :deep(.tree-table-root) { background: #fff; border-radius: 12px; border: 1px solid #e5e8ed; overflow: hidden; height: 100%; }
</style>
